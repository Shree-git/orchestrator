...
const DialogContentPrimitive =
  DialogPrimitive.Content as React.ForwardRefExoticComponent<
...
const DialogClosePrimitive =
  DialogPrimitive.Close as React.ForwardRefExoticComponent<
...
const DialogTitlePrimitive =
  DialogPrimitive.Title as React.ForwardRefExoticComponent<
...
const DialogOverlayPrimitive =
  DialogPrimitive.Overlay as React.ForwardRefExoticComponent<
