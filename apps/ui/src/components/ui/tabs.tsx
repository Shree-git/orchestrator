...
const TabsTriggerPrimitive =
  TabsPrimitive.Trigger as React.ForwardRefExoticComponent<
...
const TabsContentPrimitive =
  TabsPrimitive.Content as React.ForwardRefExoticComponent<
