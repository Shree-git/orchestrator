...
export function FeatureSuggestionsDialog({
  ...
  const currentConfig = currentSuggestionType
    ? suggestionTypeConfig[currentSuggestionType]
    : null;
        ...
        {!hasStarted ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center py-8">
            <p className="text-muted-foreground text-center max-w-lg mb-8">
              Our AI will analyze your project and generate actionable
              suggestions. Choose what type of analysis you want to perform:
            </p>
            ...
            <div className="flex gap-2 w-full justify-between">
              <div className="flex gap-2">
                ...
                {currentSuggestionType && (
                  <Button
                    variant="outline"
                    onClick={() => handleGenerate(currentSuggestionType)}
                  >
                    {currentConfig && (
